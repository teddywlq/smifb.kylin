...
static int smi_bo_verify_access(struct ttm_buffer_object *bo, struct file *filp)
{
	...
	return 0;
#elif 0 //LINUX_VERSION_CODE < KERNEL_VERSION(4,9,0)
...
struct ttm_bo_driver smi_bo_driver = {
	...
	.move = NULL,
#endif
#if 1//(LINUX_VERSION_CODE >= KERNEL_VERSION(4,7,0) && LINUX_VERSION_CODE < KERNEL_VERSION(4,11,0))
...
#if 0//LINUX_VERSION_CODE >= KERNEL_VERSION(4,9,0)	
